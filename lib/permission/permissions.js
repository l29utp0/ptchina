...
const Metadata = Object.seal(Object.freeze(Object.preventExtensions({
	...
	[Permissions.USE_MARKDOWN_DETECTED]: { label: 'Big', desc: 'Use big' },
	...
	[Permissions.USE_MARKDOWN_IMAGE]: { label: 'Embed Images', desc: 'Embed images' },

	[Permissions.DONOR]: { title: 'Outros', label: 'Doador', desc: 'Este danone é um amigo veradeiro e honesto', parent: Permissions.ROOT },
