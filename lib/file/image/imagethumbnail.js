...
// Decide whether to animate WebP thumbnail and update thumbextension
let firstFrameOnly = true;
if (file.hasThumb
	&& file.mimetype === 'image/gif'
	&& animatedGifThumbnails === true) {
	firstFrameOnly = false;
	file.thumbextension = '.webp';
}

// If enabled, make animated WebP thumbs with ffmpeg
if (ffmpegGifThumbnails && !firstFrameOnly) {
	...
	const complexFilters = [
		/* This complex filter scales (resizes) and handles transparency.
		   WebP encoding supports transparency and frame-by-frame encoding natively. */
