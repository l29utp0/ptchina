...
const updateMarkdownPerms = () => {
	replacements = [
		...
		{ permission: Permissions.USE_MARKDOWN_DETECTED, regex: detectedRegex, cb: (permissions, match, detected) => `<span class='big'>${detected.slice(0,30)}</span>${detected.slice(30)}` },
