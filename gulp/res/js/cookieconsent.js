!function(t) {
    if (!t.isInit) {
        var e = {
            ...
            extend: function(t, e) {
                for (var n in e)
                    e.hasOwnProperty(n) && (n in t && this.isPlainObj(t[n]) && this.isPlainObj(e[n]) ? this.extend(t[n], e[n]) : t[n] = e[n]);
                return t
            },
        ...
        t.Popup = function() {
            var n = {
                ...
                content: {
                    ...
                    link: "Learn more",
                    href: "/faq.html#privacidadecookies",
                    target: "_blank",
                    button: "Got it!"
                },
            ...
            function s(t) {
                ...
                e.removeClass(t, "wpcc-invisible")
            }
            function o(e) {
            ...
            function r(n) {
                ...
                return a.addEventListener("click", this.onButtonClick),
            ...
            return i.prototype.init = function(i) {
                    ...
                    (function(n) {
                        ...
                        o && function(e, n, i) {
                            ...
                            var s = {}
                              , o = n.popup
                              , r = n.button;
                            o && (s[i + ".wpcc-container"] = ["background-color: " + o.background, "border-color: " + o.border, "color: " + o.text],
                            s[i + " .wpcc-privacy," + i + " .wpcc-privacy:active," + i + " .wpcc-privacy:visited"] = ["color: " + o.text],
                            r && (s[i + " .wpcc-btn"] = ["color: " + r.text, "background-color: " + r.background],
                            ...
                            var p = -1;
                            for (var l in s)
                                s.hasOwnProperty(l) && c.sheet.insertRule(l + "{" + s[l].join(";") + "}", ++p)
                        }(i, n, "." + s);
                        return o
                    }
                ...
                .call(this));
                this.options.pushdown ? (this.wrapper = r.call(this, '<div class="wpcc-pushdown-wrap">' + s + "</div>"),
                this.wrapper.style.display = "",
                this.element = this.wrapper.firstChild,
                this.element.style.display = "none",
                e.addClass(this.element, "wpcc-invisible")) : (this.wrapper = null,
                this.element = r.call(this, s)),
            ...
            i.prototype.destroy = function() {
                ...
                this.onButtonEnter && this.element && (this.element.removeEventListener("keyup", this.onButtonEnter),
            ...
            i.prototype.open = function(e) {
                if (this.element)
                    return this.isOpen() || (t.fading ? this.fadeIn() : this.element.style.display = ""),
                    this
            }
            ,
            i.prototype.close = function() {
                if (this.element)
                    return this.isOpen() && (t.fading ? this.fadeOut() : this.element.style.display = "none"),
                    this
            }
            ,
            i.prototype.fadeIn = function() {
                var n = this.element;
                if (t.fading && n && (this.afterFading && o.call(this, n),
                e.hasClass(n, "wpcc-invisible"))) {
                    if (n.style.display = "",
                    this.options.pushdown) {
                        var i = 0
                          , r = this.element.clientHeight;
                        e.hasClass(this.element, "wpcc-border-1") ? i = 1 : e.hasClass(this.element, "wpcc-border-2") ? i = 2 : e.hasClass(this.element, "wpcc-border-3") ? i = 3 : e.hasClass(this.element, "wpcc-border-4") ? i = 4 : e.hasClass(this.element, "wpcc-border-5") && (i = 5),
            ...
            i.prototype.fadeOut = function() {
                var n = this.element;
                n && t.fading && (this.displayTimeout && (clearTimeout(this.displayTimeout),
                s.bind(this, n)),
                e.hasClass(n, "wpcc-invisible") || (this.options.pushdown && (this.element.parentNode.style.maxHeight = ""),
            ...
            i.prototype.setStatus = function(t) {
                ...
                e.setCookie(n.name, t, n.expiryDays, n.domain, n.path, n.secure),
