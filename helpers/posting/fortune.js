...
const fortunes = [
	...
	'Vais encontrar o verdadeiro amor em Moçambique',
	...
	'Vais ser assaltado por um serrano do ultramar com um cajado',
	'Vais encontrar a Marta da tua vida',
	'Tens Covid',
	'Amanhã o teu dispositivo vai pifar',
	'Um urbanita visitará a tua aldeia',
	'38°47 24.9 N 9°06 34.9 W',
	'Ela tem um pénis feminino uwu',
	'Vou te explicar a razão dos meus erros ortográficos e isto é facto e n arrogância mas chama-lhe o quiseres, tenho um QI bastante acima da média e confesso estou sobre um efeito de um estimulante que ainda aumenta a velocidade do raciocinio. Escrevo depressa mas penso ainda mais depressa. Logo cometo falácias de escrita. Não por falta de inteligência ou incapacidade mental. Precisamente o contrário a velocidade a que escrevo é minima comparado á velocidade que penso. Aqui quem têm falta de capacidade és tu caso n compreendas isto depois de uma explicação detalhada',
	'Volta',
	'INÊEEEEEEEEESSSSS',
	'Vais beber água com o Ronaldo',
	'As autoridades foram informadas, um agente encontra-se a caminho da sua residência',
	'Quero me mudar para Portugal, quero ser cidadão europeu',
	'Por 600 kwanzas',
	'A ABIN agradece a sua contribuição',
	'O seu verdadeiro amor estará na Bahia',
	'Perdeu, playboy',
	'R$ 1.000.000,00',
	'Você dançará pé-diskomandado hoje à noite',
	'Vá de retro coisa ruim!',
	'Você vai sonhar com Paulo Kogos',
	'Asa de urubu, pena de galinha, se for duplo, o OP vai virar uma mocinha.',
	'Ora pois',
	'Vai comer o bacalhau e vai gostar safado',
	'Quero mudar-me para o Brasil, quero levar um tiro',
	'É ptchan, tudo com letras pequenas, obrigado',
	'Que bonito, é um clube privado ou algo assim?',
	...
	'Mais medicação, menos teorias da conspiração',
	'Comerás sopa de macaco e serás feliz',
