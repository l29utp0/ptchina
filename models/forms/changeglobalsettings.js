...
module.exports = async (req, res) => {
	...
	const newSettings = {
		...
		frontendScriptDefault: {
			...
			hoverExpandsFollowCursor: booleanSetting(req.body.frontend_script_default_hover_expands_follow_cursor, oldSettings.frontendScriptDefault.hoverExpandsFollowCursor),
		...
		boardDefaults: {
			...
			autoBumplockTime: numberSetting(req.body.board_defaults_auto_bumplock_time, oldSettings.boardDefaults.autoBumplockTime),
