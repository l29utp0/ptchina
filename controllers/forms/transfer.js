...
module.exports = {
    ...
    controller: async (req, res, next) => {
        ...
        const errors = await checkSchema([
            // Simplified check: allow transfer if user has ROOT, otherwise check for DONOR
            { result: res.locals.permissions.get(Permissions.ROOT) || !res.locals.permissions.get(Permissions.DONOR), 
              expected: true, 
              error: __('Donors cannot transfer boards') 
            },
